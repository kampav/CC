    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#F8FAFC' }}>
      <div style={{ background: 'white', borderRadius: '16px', border: '1px solid #E2E8F0', padding: '2.5rem', width: '100%', maxWidth: '400px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '1.5rem', color: '#0F172A', fontWeight: 700 }}>Merchant Portal</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{ width: '100%', padding: '0.75rem', background: '#7C3AED', color: 'white', border: 'none', borderRadius: '8px', fontSize: '0.95rem', fontWeight: 600, cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1 }}
          >
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.8rem', color: '#94A3B8' }}>
          Demo: merchant@demo.com / demo1234
        </p>
      </div>
    </div>
  );
