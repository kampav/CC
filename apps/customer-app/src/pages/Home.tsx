  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: '20px', left: '-40px', width: '150px', height: '150px', borderRadius: '50%', background: 'rgba(255,255,255,0.04)' }} />
        <div style={{ position: 'relative' }}>
          ...
          <p style={{ margin: '0 0 2rem', fontSize: '1.05rem', color: '#C7D2FE', maxWidth: '550px', lineHeight: 1.7 }}>
            Discover exclusive cashback offers from your favourite brands. Activate, shop, and earn rewards automatically.
          </p>
                  ...
                  >
                    ...
                    <div style={{ padding: '0.75rem 1rem 1rem' }}>
                      <div style={{ display: 'flex', gap: '0.3rem', marginBottom: '0.4rem' }}>
                        {offer.category && (
                          <span style={{ padding: '0.15rem 0.5rem', borderRadius: '6px', fontSize: '0.65rem', background: '#F1F5F9', color: '#475569' }}>
                            {offer.category}
                          </span>
                        )}
                        <span style={{ padding: '0.15rem 0.5rem', borderRadius: '6px', fontSize: '0.65rem', fontWeight: 600, background: brandColor.bg, color: brandColor.text }}>
                          {BRAND_LABELS[offer.brand] || offer.brand}
                        </span>
                      </div>
                      <h4 style={{ margin: '0 0 0.25rem', color: '#1E293B', fontSize: '0.9rem', fontWeight: 600 }}>{offer.title}</h4>
                      {offer.cashbackRate && (
